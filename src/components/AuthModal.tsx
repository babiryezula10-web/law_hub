...
export const AuthModal: React.FC<AuthModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
      <div className="bg-[#090f1e]/90 border border-white/10 rounded-3xl max-w-lg w-full p-6 sm:p-8 space-y-6 shadow-2xl relative text-slate-100 max-h-[92vh] overflow-y-auto overflow-hidden backdrop-blur-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-3 rounded-xl bg-[#c89d42] hover:bg-[#dfb858] text-[#050811] font-heading font-extrabold text-xs tracking-wider uppercase transition shadow-lg flex items-center justify-center gap-2 disabled:opacity-50 cursor-pointer"
          >
