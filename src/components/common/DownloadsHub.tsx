// ─────────────────────────────────────────────────────────────
// LawHub Uganda — Common UI: DownloadsHub
// Offline compendium and materials download repository.
// ─────────────────────────────────────────────────────────────
    ...
    <div className="relative space-y-6 sm:space-y-8 pb-12 text-slate-100">
      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
        {downloadItems.map((item, idx) => (
          <div
            key={idx}
            className="bg-[#121216]/60 border border-white/10 rounded-3xl p-5 sm:p-6 space-y-4 hover:border-[#c89d42]/40 transition shadow-lg flex flex-col justify-between backdrop-blur-md hover:bg-[#1a1a20]/70"
          >
            <div className="space-y-2">
              ...
              <h3 className="font-bold text-sm sm:text-base text-slate-100">{item.title}</h3>
            ...
            <a
              ...
              className="w-full py-2.5 rounded-2xl bg-[#c89d42] hover:bg-[#dfb858] text-[#050811] font-bold text-xs transition flex items-center justify-center gap-2 shadow-md font-heading cursor-pointer active:scale-[0.98]"
            >
