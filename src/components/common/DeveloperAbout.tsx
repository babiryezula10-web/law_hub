// ─────────────────────────────────────────────────────────────
// LawHub Uganda — Common UI: DeveloperAbout
// Administrative profile presenting founder and system architect.
// ─────────────────────────────────────────────────────────────
...
export function DeveloperAbout() {
  return (
    <div className="relative max-w-4xl mx-auto space-y-8 sm:space-y-10 pb-16 text-slate-100">
      <WatermarkBackground
        type="cyber_scales"
        opacity={0.16}
        blendMode="normal"
      ...
      {/* Hero Banner */}
      <div className="relative z-10 bg-slate-950/40 border border-white/10 rounded-3xl p-6 sm:p-12 text-center space-y-6 shadow-2xl overflow-hidden backdrop-blur-xl">
        ...
        <div className="space-y-2">
          ...
          <h1 className="font-heading font-extrabold text-2xl sm:text-4xl text-slate-100">
            Babirye Zula
          </h1>
        ...
        <div className="max-w-2xl mx-auto space-y-4 text-xs sm:text-sm text-slate-300 leading-relaxed text-left bg-black/30 p-4 sm:p-6 rounded-2xl border border-white/10 backdrop-blur-sm">
          <p>
      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
        {/* Card 1: Vision */}
        <div className="bg-slate-950/40 border border-white/10 rounded-3xl p-5 sm:p-6 space-y-3 shadow-xl backdrop-blur-md">
