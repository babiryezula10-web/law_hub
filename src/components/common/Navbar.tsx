// ─────────────────────────────────────────────────────────────
// LawHub Uganda — Common UI: Navbar
// Top fixed navigation header with role selector, global search,
// quick navigation links, ambience picker, and user dropdown.
// ─────────────────────────────────────────────────────────────
    ...
    <header className="sticky top-0 z-40 bg-[#080d1a]/80 backdrop-blur-xl border-b border-white/10 transition-colors">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-3 sm:gap-4">
        ...
        <button
          ...
          className="hidden md:flex items-center gap-3 bg-white/[0.04] hover:bg-white/[0.08] text-slate-300 hover:text-white px-4 py-2 rounded-xl border border-white/10 hover:border-[#c89d42]/40 transition text-xs min-w-[240px] lg:min-w-[320px] shadow-sm cursor-pointer backdrop-blur-md"
        >
        ...
        <nav className="hidden lg:flex items-center gap-1 text-xs font-medium">
          <button
            ...
            className={`px-3 py-1.5 rounded-lg transition cursor-pointer ${
              activeTab === 'landing'
                ? 'bg-[#c89d42] text-[#050811] font-bold shadow-sm'
                : 'text-slate-300 hover:text-[#c89d42] hover:bg-white/[0.06]'
            }`}
          >
            Home
          </button>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2 p-1.5 rounded-xl border border-white/10 bg-white/[0.04] hover:bg-white/[0.08] hover:border-[#c89d42]/40 transition cursor-pointer backdrop-blur-md active:scale-[0.98]"
            >
              ...
              <span className="text-xs font-semibold text-slate-200 hidden md:block max-w-[110px] truncate">
                {user.name}
              </span>
            ...
            {/* Profile Dropdown */}
            {userDropdownOpen && (
              <div className="absolute right-0 mt-2 w-64 bg-[#090f1e]/95 backdrop-blur-2xl border border-white/10 rounded-2xl shadow-2xl py-2 z-50 text-xs animate-in fade-in zoom-in-95 duration-150">
