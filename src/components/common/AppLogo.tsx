// ─────────────────────────────────────────────────────────────
// LawHub Uganda — Common UI: AppLogo
// Official branding emblem and responsive wordmark.
// ─────────────────────────────────────────────────────────────
...
export function AppLogo({
  ...
  return (
    ...
    >
      <div
        className={`relative overflow-hidden p-0.5 bg-gradient-to-tr from-amber-500 via-amber-300 to-amber-600 shrink-0 transition-transform duration-300 hover:scale-105 ${sizeClasses[size]} ${glowClasses[size]}`}
      >
